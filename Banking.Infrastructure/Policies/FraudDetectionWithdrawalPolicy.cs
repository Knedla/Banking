...
public class FraudDetectionWithdrawalPolicy : IWithdrawalPolicy // not used, I left them here as an idea...
{
    private readonly IFraudDetectionService _fraudService;

    public FraudDetectionWithdrawalPolicy(IFraudDetectionService fraudService)
    {
