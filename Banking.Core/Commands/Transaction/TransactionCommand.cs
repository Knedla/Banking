using Banking.Core.Attributes;
using Banking.Core.Commands.Interfaces;
using Banking.Core.Commands.Transaction.Interfaces;
using Banking.Core.Enumerations;
using Banking.Core.Exceptions;
using Banking.Core.Helpers;
using Banking.Core.Policies;
using Banking.Core.Services.Interfaces;
            ...
            foreach (var (phase, command) in _ordered)
            {
                ...
                do
                {
                    try
                    {
                        ...
                        var stopwatch = Stopwatch.StartNew(); // pass it through constructor ... ///////////////////////////////////////////////////////////////////////////
